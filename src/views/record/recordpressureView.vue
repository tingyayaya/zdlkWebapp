    ...
    <div class="all-record-view">
        ...
        <div class="content formBox">
            <div class="input-danwei">
                <span>mmHg</span>
                <input type="number" placeholder="请输入收缩压" class="input-text" v-model="form.number1">
            </div>
            <div class="input-danwei">
                <span>mmHg</span>
                <input type="number" placeholder="请输入舒张压" class="input-text" v-model="form.number2">
            </div>
...
export default {
    ...
    methods: {
        ...
        getData() {
          ...
          this.$axios({
            method: 'get',
            url: self.baseurl.viewer+'/Insert3.jsp',
            params: {
              'skt138.skf2795': self.form.number1,
              'skt138.skf2265': self.form.number2,
