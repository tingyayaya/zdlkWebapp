<template>
    <div class="home-list-view">
        <my-header :title="title" :left="true">
            <router-link :to="{name: 'recordPressureView'}" slot="record">
                <span>记血压</span>
            </router-link>
        </my-header>
        <mt-datetime-picker
       ...
       <mt-datetime-picker
        ...
        <div class="bg-grey padding-t-20 myhome-list">
            ...
            <div class="section-h">
                ...
                <div class="part-content bg-write">
                   <common-charts2 :dataList = "dataList1" :chartTitle="chartTitle1" v-if="flag" :initVal="initVal" containerId="container1" @selectDate="selectDate"></common-charts2>
                </div>
            ...
            <div  class="section-h">
                <div class="nav">
                 ...
                 <div class="part-content bg-write">
                   <common-charts2 :dataList = "dataList2" :chartTitle="chartTitle2" v-if="flag" :initVal="initVal" containerId="container2" @selectDate="selectDate"></common-charts2>
                </div>
            </div>
            <div class="section-h">
                <div class="nav">
...
import CommonCharts2 from '@/components/CommonCharts2'
...
export default {
    data() {
        return{
            chartTitle1: '收缩压曲线变化（单位：mmHg)',
            chartTitle2: '舒张压曲线变化（单位：mmHg)',
            initVal: '',
            flag: false,
            dataList1: [],
            dataList2: [],
    ...
    created(){
      ...
      //收缩压
      this.$store.dispatch('getSystolicPressureList').then(function(){
        self.dataList1 = self.$store.getters.getSystolicPressureList;
        self.flag = true;
      })
      //舒张压
      this.$store.dispatch('getDiastolicPressureList').then(function(){
        self.dataList2 = self.$store.getters.getDiastolicPressureList;
        self.flag = true;
      })
    ...
    methods:{
        ...
        check(){
          ...
          if(!(this.startValue&&this.endValue)){
            ...
            this.$store.dispatch('getSystolicPressureList',[this.startValue,this.endValue]).then(function(){
              self.dataList1 = self.$store.getters.getSystolicPressureList;
            })
            this.$store.dispatch('getDiastolicPressureList',[this.startValue,this.endValue]).then(function(){
              self.dataList2 = self.$store.getters.getDiastolicPressureList;
            })
          }
        },
    ...
    components: { MyHeader,CommonCharts, FistFoodList, CommonCharts2 }
}
</script>
