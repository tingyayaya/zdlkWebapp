...
export default {
    ...
    created(){
      ...
      this.$store.dispatch('getWeightList').then(function(){
        self.dataList = self.$store.getters.getWeightList;
        self.flag = true;
      })
      //初始值
    ...
    methods:{
        ...
        check(){
          ...
          if(!(this.startValue&&this.endValue)){
            ...
            this.$store.dispatch('getWeightList',[this.startValue,this.endValue]).then(function(){
              self.dataList = self.$store.getters.getWeightList;
            })
          }
        },
