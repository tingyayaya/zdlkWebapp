<template>
    <div class="home-list-view">
        <my-header :title="title" :left="true">
            <router-link :to="{name: 'recordSugarView'}" slot="record">
                <span>记血糖</span>
            </router-link>
        </my-header>
        <mt-datetime-picker
       ...
       <mt-datetime-picker
        ...
        <div class="bg-grey padding-t-20 myhome-list">
            ...
            <div class="section-h">
                ...
                <div class="part-content bg-write">
                   <common-charts :dataList = "dataList" :chartTitle="chartTitle" v-if="flag" :initVal="initVal" containerId="container1" @selectDate="selectDate"></common-charts>
                </div>
            </div>
            <div class="section-h">
                <div class="nav">
...
export default {
    ...
    created(){
      ...
      this.$store.dispatch('getSugarList').then(function(){
        self.dataList = self.$store.getters.getSugarList;
        self.flag = true;
      })
      //初始值
    ...
    methods:{
        ...
        check(){
          ...
          if(!(this.startValue&&this.endValue)){
            ...
            this.$store.dispatch('getWaistList',[this.startValue,this.endValue]).then(function(){
              self.dataList = self.$store.getters.getWaistList;
            })
          }
        },
        openPicker() {
    ...
    components: { MyHeader,CommonCharts, FistFoodList }
}
</script>
