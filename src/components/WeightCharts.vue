                ...
                series: [{
                    ...
                    events:{
                        click: function(e){
                            ...
                            document.getElementById('values').innerHTML=e.point.options.y+'kg';
                            var dif = e.point.options.y - sessionStorage.initVal;
                           
                            document.getElementById('dif').innerHTML=dif.toFixed(1)+'kg';
    ...
    mounted() {
        ...
        for(var i=0; i<len; i++){
            ...
            if(reg.test(this.timex[i].time)){
                ...
                arr2[1] = Number(this.timex[i].value);
                this.option.series[0].data.push(arr2);
            }
        }
        
        //console.log(this.option.series[0].data)
        sessionStorage.initVal = '45';
